...
## Threads Templates (RU)

### Микро-инсайт
```
[Конкретное наблюдение или факт из жизни фаундера]

[Неожиданный вывод или переосмысление]

#бутстрэп #солофаундер #[тематический хештег]
```
...
[Твой ответ/позиция — 1-2 предложения]
...
### Карусель (серия постов)
```
Пост 1 (хук):
[Обещание ценности + "Тред 👇"]

Пост 2-4 (содержание):
[По одному пункту на пост — конкретика и цифры]

Пост 5 (закрытие):
[Вывод + вопрос для обсуждения]
```
...
For the comprehensive hooks guide (7 types, Slippery Slide, awareness levels, founder templates), see [hooks-guide.md](hooks-guide.md).
