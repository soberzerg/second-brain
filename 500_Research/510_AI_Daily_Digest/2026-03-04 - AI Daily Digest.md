...
Легенда computer science Дональд Кнут опубликовал paper о том, как Claude Opus 4.6 за ~1 час (31 exploration step) решил открытую задачу по декомпозиции графов из его книги. Это значимый benchmark для math/reasoning capabilities LLM-моделей. Факт того, что Кнут — известный скептик ИИ — меняет позицию, вызвал широкий резонанс (4277 лайков).
